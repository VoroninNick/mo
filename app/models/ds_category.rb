class DsCategory < ActiveRecord::Base
  attr_accessible :name, :icon, :parent_id, :t_name, :child_category_id

  has_many :child_categories, class_name: "DsCategory",
           foreign_key: "parent_id"

  belongs_to :parent, class_name: "DsCategory"
  ...
  class Translation
    attr_accessible :locale, :ds_category_id
  ...
  has_many :drink_sets, inverse_of: :ds_category
