...
unless RakeSettings.self_skip_initializers?
  ...
  RailsAdmin.config do |config|
    ...
    included_models = [ User, Cart, LineItem, Publication, Product, PhotoGallery, Category, Promotion, DsCategory, DCategory, DrinkSet, Decor, ProductProperty, ProductPack, EmailTo, Delivery, Payment, Warranty]
